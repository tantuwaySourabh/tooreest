...
import com.ebabu.tooreest.adapter.NotificationAdapter;
import com.ebabu.tooreest.beans.Notification;
...
public class NotificationsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initView();
        Utils.setUpToolbar(context, getString(R.string.notifications));
